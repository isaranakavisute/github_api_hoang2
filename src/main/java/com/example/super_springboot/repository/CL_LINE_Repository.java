...
public interface CL_LINE_Repository extends JpaRepository<ClLine, Long> {
    ...
    @Query(value = "SELECT CLLI_OID,CLAM_OID,INCUR_DATE_FROM,INCUR_DATE_TO,SCMA_OID_CL_TYPE,SCMA_OID_BED_TYPE,PRES_AMT,APP_AMT,PRIOR_PAID,SCMA_OID_CL_LINE_STATUS,PAY_DATE,PAY_AMT,LINE_NO,PAYEE,MEMB_OID,CHQ_DATE,RCV_DATE, DAYS,PAY_ADDR1,PAY_ADDR2,PAY_ADDR3,PAY_ADDR4,SCMA_OID_PAY_PROVINCE,SCMA_OID_COUNTRY_PAY,SCMA_OID_CL_PAYMENT_METHOD,PAY_ZIP_CDE,LINE_REV_NO,PROV_OID,PROV_NAME,SCMA_OID_CL_PAY_TO,ORG_PRES_AMT,ORG_ADJ_PRES_AMT,ADJ_PRES_AMT,BEN_POPL_OID,POPL_OID,SCMA_OID_COUNTRY_TREATMENT,STAGE_IDX,BEHD_OID,DIAG_OID,SCMA_OID_YN_ER,SCMA_OID_YN_TREAT_PLAN,SCMA_OID_YN_WP,SCMA_OID_CCY_PRES,FX_RATE,SCMA_OID_CCY_PAY,PAY_FX_RATE,REMARK,PEND_VAL,PAY_PRINT_IN_OTHER_LANG_IND,HOSPITAL_NUMBER,HOSP_SUB_NO,CL_PAY_VOUCHER,SCMA_OID_YN_ACC,SCMA_OID_YN_HOSPITAL_PDN,CRT_USER,CRT_DATE,UPD_USER,UPD_DATE,SCMA_OID_PRODUCT " + "FROM CL_LINE where CLAM_OID=:CLAM_OID AND SCMA_OID_CL_LINE_STATUS != 'CL_LINE_STATUS_RV' ORDER BY LINE_NO ASC", nativeQuery = true)
    Collection<ClLine> get_CL_Line(Long CLAM_OID);

    @Query(value = "SELECT CLLI_OID,CLAM_OID,INCUR_DATE_FROM,INCUR_DATE_TO,SCMA_OID_CL_TYPE,SCMA_OID_BED_TYPE,PRES_AMT,APP_AMT,PRIOR_PAID,SCMA_OID_CL_LINE_STATUS,PAY_DATE,PAY_AMT,LINE_NO,PAYEE,MEMB_OID,CHQ_DATE,RCV_DATE,DAYS,PAY_ADDR1,PAY_ADDR2,PAY_ADDR3,PAY_ADDR4,SCMA_OID_PAY_PROVINCE,SCMA_OID_COUNTRY_PAY,SCMA_OID_CL_PAYMENT_METHOD,PAY_ZIP_CDE,LINE_REV_NO,PROV_OID,PROV_NAME,SCMA_OID_CL_PAY_TO,ORG_PRES_AMT,ORG_ADJ_PRES_AMT,ADJ_PRES_AMT,BEN_POPL_OID,POPL_OID,SCMA_OID_COUNTRY_TREATMENT,STAGE_IDX,BEHD_OID,DIAG_OID,SCMA_OID_YN_ER,SCMA_OID_YN_TREAT_PLAN,SCMA_OID_YN_WP,SCMA_OID_CCY_PRES,FX_RATE,SCMA_OID_CCY_PAY,PAY_FX_RATE,REMARK,PEND_VAL,PAY_PRINT_IN_OTHER_LANG_IND,HOSPITAL_NUMBER,HOSP_SUB_NO,CL_PAY_VOUCHER,SCMA_OID_YN_ACC,SCMA_OID_YN_HOSPITAL_PDN,CRT_USER,CRT_DATE,UPD_USER,UPD_DATE,SCMA_OID_PRODUCT " + "FROM CL_LINE where MEMB_OID=:MEMB_OID AND SCMA_OID_CL_LINE_STATUS != 'CL_LINE_STATUS_RV' ORDER BY LINE_NO ASC", nativeQuery = true)
